...
(function($) {
    $.fn.lightBox = function(settings) {
        ...
        settings = jQuery.extend({
            ...
            imageLoading: 'Gicons/loading.gif',
            imageBtnPrev: 'Gicons/prev.png',
            imageBtnNext: 'Gicons/next.png',
            imageBtnClose: 'Gicons/close.png',
            imageBlank: 'Gicons/lightbox-blank.gif',
            imageBtnBottomPrev: 'Gicons/btm_prev.gif',
            imageBtnBottomNext: 'Gicons/btm_next.gif',
            imageBtnPlay: 'Gicons/start.png',
            imageBtnStop: 'Gicons/pause.png',
        ...
        function _set_interface() {
            ...
            $('body').append('<div id="jquery-overlay" /><div id="jquery-box"><div id="jquery-lightbox"><div id="lightbox-container-image-box"><div id="lightbox-container-image-box-top"><div id="lightbox-container-image-box-top-left"><img src="' + settings.imageBtnPlay + '"></div><div id="lightbox-container-image-box-top-middle"></div><div id="lightbox-container-image-box-top-right"><img src="' + settings.imageBtnClose + '"></div></div><div id="lightbox-container-image"><img id="lightbox-image"/></div><div id="lightbox-nav" style="display: block;"><a id="lightbox-nav-btnPrev" href="#" title="' + settings.txtPrev + '" /><a id="lightbox-nav-btnNext" href="#" title="' + settings.txtNext + '" /></div><div id="lightbox-loading" style="display: none;"><a id="lightbox-loading-link" href="#"><img src="' + settings.imageLoading + '"></a></div></div><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><span id="lightbox-image-details-caption">Image name</span> &nbsp;|&nbsp;</div></div></div>');
