...
class App():
    ...
    def __init__(self,window):
        ...
        button3 = tkinter.Button(frame2, text="이미지 자르기", width=26, pady=10, bg="#f9f9f9", fg="#000", relief="solid", overrelief="solid", font=('나눔바른고딕',12,'normal'))
        ...
        self.emptylabel2 = tkinter.Label(window, width=30, pady=10, bg="#000", text="1.영역 선택하기 클릭", fg="#fff", font=('나눔바른고딕',17,'bold'))
        self.emptylabel2.grid(row=8, column=0, columnspan=30)
        self.emptylabel3 = tkinter.Label(window, width=30, pady=10, bg="#000", text="2.이미지 자르기 클릭", fg="#fff", font=('나눔바른고딕',17,'bold'))
        self.emptylabel3.grid(row=9, column=0, columnspan=30)
        self.emptylabel4 = tkinter.Label(window, width=30, pady=10, bg="#000", text="3.색상 선택하기 클릭", fg="#fff", font=('나눔바른고딕',17,'bold'))
        self.emptylabel4.grid(row=10, column=0, columnspan=30)
        self.emptylabel5 = tkinter.Label(window, width=50, pady=10, bg="#000", text="4.검은색(색칠한 부분 지우기),하얀색(색칠한 부분 살리기)", fg="#fff", font=('나눔바른고딕',17,'bold'))
        self.emptylabel5.grid(row=11, column=0, columnspan=50)
        self.emptylabel6 = tkinter.Label(window, width=50, pady=10, bg="#000", text="5.이미지 자르기 클릭 후 저장 or 다시 3번으로 돌아가기", fg="#fff", font=('나눔바른고딕',17,'bold'))
        self.emptylabel6.grid(row=12, column=0, columnspan=50)
